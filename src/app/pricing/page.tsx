...
export default function PricingPage() {
  ...
  const proPlan = isAnnual ? 'pro_yearly' : 'pro_monthly'
  const advancedPlan = isAnnual ? 'advanced_yearly' : 'advanced_monthly'
      ...
      <section className="relative overflow-hidden border-b border-[#e8ded3] bg-[#f3ece4]">
        ...
        <div className="relative mx-auto max-w-[1100px] px-6 py-16 text-center md:px-10 md:py-20">
          ...
          <p className="mx-auto mt-5 max-w-[820px] text-base leading-8 text-[#5b5d59] md:text-lg">
            ...
            deeper practice, and consistent AI coaching. Annual billing is
            selected by default because it gives the best value.
          </p>
          ...
          <p className="mt-4 text-sm text-[#6a6c67]">
            Annual plans are billed upfront and show the lower monthly unit price.
          </p>
        </div>
      </section>
