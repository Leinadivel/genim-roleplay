  ...
  return (
    <main className="min-h-screen bg-[#f7f3ee] px-6 py-12 text-[#1f1f1c]">
      <div className="mx-auto max-w-[900px]">
        ...
        <Link
          href="/"
          className="mb-6 inline-flex items-center gap-2 rounded-full border border-[#ddd4ca] bg-white px-5 py-3 text-sm font-semibold text-[#1f1f1c] transition hover:bg-[#faf8f5]"
        >
